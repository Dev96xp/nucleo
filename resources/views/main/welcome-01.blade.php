...
<body>
    ...
    <div id="image-track" data-mouse-down-at="0" data-prev-percentage="0">
        <img class="image" src="{{ asset('img/woman1.jpg') }}" alt="" draggable="false">
        <img class="image" src="{{ asset('img/woman2.jpg') }}" alt="" draggable="false">
        <img class="image" src="{{ asset('img/woman3.jpg') }}" alt="" draggable="false">
        <img class="image" src="{{ asset('img/woman4.jpg') }}" alt="" draggable="false">
        <img class="image" src="{{ asset('img/woman1.jpg') }}" alt="" draggable="false">
        <img class="image" src="{{ asset('img/woman2.jpg') }}" alt="" draggable="false">
        <img class="image" src="{{ asset('img/woman3.jpg') }}" alt="" draggable="false">
        <img class="image" src="{{ asset('img/woman4.jpg') }}" alt="" draggable="false">
